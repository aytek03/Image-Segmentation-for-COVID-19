...
if __name__ == '__main__':
    ...
    if opt.backbone == 'Res2Net50':
        ...
        print('Backbone loading: iresnet50')
        from Code.model_lung_infection.InfNet_iresnet import Inf_Net
    elif opt.backbone == 'resnext':
        print('Backbone loading: resnext')
        from Code.model_lung_infection.InfNet_ResNext import Inf_Net
    elif opt.backbone == 'resNest':
        print('Backbone loading: resNest')
        from Code.model_lung_infection.InfNet_ResNest import Inf_Net
    else:
